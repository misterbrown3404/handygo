...
class BookingFlowController extends GetxController {
  ...
  Future<void> submitBooking() async {
    try {
      ...
      Get.snackbar("Success", "Booking created successfully", backgroundColor: Colors.green, colorText: Colors.white);
    } catch (e) {
      Get.snackbar("Error", "Please ensure Date (YYYY-MM-DD) and Time (HH:MM) are correct", backgroundColor: Colors.redAccent, colorText: Colors.white);
    } finally {
      isLoading(false);
    }
  }
