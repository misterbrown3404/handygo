...
class ProfileController extends GetxController {
  ...
  Future<void> uploadAvatar(String path) async {
    try {
      ...
      Get.snackbar("Error", "Failed to upload image: $e", backgroundColor: Colors.redAccent, colorText: Colors.white);
    } finally {
      isLoading(false);
    }
  }
  ...
  Future<void> updateProfile() async {
    try {
      ...
      Get.snackbar("Error", "Failed to update profile: $e", backgroundColor: Colors.redAccent, colorText: Colors.white);
    } finally {
      isLoading(false);
    }
  }
