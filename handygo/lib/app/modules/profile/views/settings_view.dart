...
class SettingsView extends GetView<ProfileController> {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _buildMenuItem("Two-Factor Authentication", Icons.security_outlined, () {}),
          
          const SizedBox(height: 32),
          _buildSectionHeader("General"),
          _buildMenuItem("Language", Icons.language_outlined, () {}, trailing: "English (US)"),
          _buildMenuItem("Privacy Policy", Icons.privacy_tip_outlined, () {}),
          _buildMenuItem("Terms of Service", Icons.description_outlined, () {}),
          
          const SizedBox(height: 32),
          _buildMenuItem("Logout", Icons.logout, () => controller.logout(), isDestructive: true),
        ],
      ),
    );
  }
  ...
  Widget _buildMenuItem(String title, IconData icon, VoidCallback onTap, {String? trailing, bool isDestructive = false}) {
    return ListTile(
      onTap: onTap,
      ...
      trailing: Row(
        ...
        children: [
          if (trailing != null)
            Text(trailing, style: TextStyle(color: Colors.grey[500], fontSize: 14)),
